...
class DatabaseDriver(object):
    ...
    def get_all_users(self):
        ...
        for row in cursor:
            users.append({"id": row[0], "name": row[1], "username": row[2], "password": row[3], "balance": row[4]})
...
#--------Extra functions for the extra credit part of the assignment--------#
    ...
    def insert_user_extra(self, name, username, balance):
        cursor = self.conn.cursor()
